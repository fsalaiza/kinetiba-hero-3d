    ...
    >
      ...
      <div style={{ position: "relative" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 0, marginLeft: "calc(-1 * clamp(24px, 4vw, 50px))", marginRight: "calc(-1 * clamp(24px, 4vw, 50px))" }}>
          <div style={{ flex: 1, height: 1, background: "linear-gradient(to right, rgba(230,230,220,0.18) 0%, rgba(230,230,220,0.18) 20%, rgba(230,230,220,0) 40%, rgba(230,230,220,0) 50%, rgba(230,230,220,0) 65%, rgba(230,230,220,0) 100%)" }} />
          <div
            style={{
              color: "#c4c4b8",
              fontSize: "clamp(9px, 1vw, 12px)",
